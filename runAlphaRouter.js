...
const wei = ethers.utils.parseUnits('0.1', 18)
...
async function main() {
  ...
  const tradeTransaction = await connectedWallet.sendTransaction(transaction).then(transaction => {console.log(transaction)})
